...
const Simplified = () => {
  ...
  useEffect(() => {
    ...
    if (query) {
      ...
      // Show all simplified resources by default
      setResults(getResourcesByType("simplified"));
    }
  }, [query]);
    ...
    <>
      ...
      <div className="container mx-auto px-4 pt-24 pb-10">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gradient mb-2">Simplified Learning</h1>
          <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Access easy-to-understand explanations of complex academic topics
          </p>
        </div>
        ...
        {isSearching ? (
          ...
          <Card className="mx-auto max-w-md">
            <CardHeader>
              <CardTitle>No simplified materials found</CardTitle>
              <CardDescription>
